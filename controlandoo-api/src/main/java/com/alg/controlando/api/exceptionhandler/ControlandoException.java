...
public class ControlandoException extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException e, WebRequest request) {
		String mensagemUsuario = mensagem.getMessage("recurso.nao-encontrado", null,LocaleContextHolder.getLocale());
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request){
		String mensagemUsuario = mensagem.getMessage("recurso.operacao-nao-permitida", null,LocaleContextHolder.getLocale());
